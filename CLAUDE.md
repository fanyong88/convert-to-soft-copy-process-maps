# convert-to-soft-copy-process-maps

Internal tool for workflow consultants to photograph flipchart process maps and instantly convert them into editable Excel or Visio workflow files using AI.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "68934550+fanyong88@users.noreply.github.com"
  git config user.name "fanyong88"
  ```
